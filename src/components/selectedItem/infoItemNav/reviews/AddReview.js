    ...
    return (
        <div className="add-review">
            ...
            <form className="add-review__form">
                ...
                <input onChange={(e) => {dispatch(changeReview(e.target.value))}} type="text" value={review} name="text" id="text" required className="add-review__form-input"/>
                <input onChange={(e) => {dispatch(changeName(e.target.value))}} type="text" value={name} name="name" id="name" placeholder="Enter your name*" required className="add-review__form-input"/>
                <div className="add-review__form-wrapper">
                    <input type="checkbox" className="add-review__form-checkbox"/>
